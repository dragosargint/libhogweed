...
usage (FILE *out)
{
  fprintf (out, "Usage: rsa-encrypt [OPTIONS] PUBLIC-KEY\n"
	   "Options:\n"
...
main(int argc, char **argv)
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  FILE *f = fopen("clear_text","r");
  if(f == NULL)
  {
      werror("Can't open file clear_text\n");
      return EXIT_FAILURE;
  }
  FILE *g = fopen("cipher_text","w");
  if(g == NULL)
  {
      werror("Can't open file cipher_text\n");
      return EXIT_FAILURE;
  }
  /////////////////////////////////////////////////////////////////////////////  
